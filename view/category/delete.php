...
<form action="index.php?controller=category&amp;action=delete"
	method="POST">
	<table class="table">
		<thead class="thead-dark">
            ...
            <?php echo i18n("Level") ?> 
				...
				<td><input type="text" class="form-control" name="level"
					value="<?php echo $category->getNivel() ?>" readonly="readonly"></td>
			</tr>
			<tr>
				<th>
            <?php echo i18n("Sex") ?> 
				...
				<td><input type="text" class="form-control" name="sex"
					value="<?php echo $category->getSexo() ?>" readonly="readonly"></td>
			</tr>
	...
	<button type="submit" class="btn btn-primary"
		value="<?php echo i18n("Delete Category") ?>"><?php echo i18n("Delete Category") ?></button>
</form>
