<?php
/**
* selectToCalendar (championship)
*
* Vista que muestra un formulario para seleccionar que campeonato
* en el que generar su calendario
*
*/
...
<form
	action="index.php?controller=championship&amp;action=generateCalendar"
	method="POST">
	<div class="container">
