...
<form action="index.php?controller=confrontationOffer&amp;action=join"
	method="POST">
	<input type="hidden" value="<?= $idPareja ?>" name="idPareja"
		id="idPareja" /> <input type="hidden" value="<?= $idParejaOffer ?>"
		name="idParejaOffer" id="idParejaOffer" /> <input type="hidden"
		value="<?= $ofertaEnfrentamiento->getIdOfertaEnfrentamiento(); ?>"
		name="idOfertaEnfrentamiento" id="idOfertaEnfrentamiento" /> <input
