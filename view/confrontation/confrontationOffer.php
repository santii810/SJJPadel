  ...
  <?php foreach ($category_wt_tournament as $category): ?>
    <tr>
        ...
        <?= $category[2] ?>
			...
			<td><a
				href="index.php?controller=confrontationOffer&amp;action=select&amp;idCategoriaCampeonato=<?= $category[3] ?>&amp;idCampeonato=<?= $category[4] ?>&amp;idCategoria=<?= $category[5] ?>&amp;idPareja=<?= $category[6] ?>">
