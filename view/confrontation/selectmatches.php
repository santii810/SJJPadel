<?php
/**
* selectmatches (confrontation)
*
* Vista que muestra un formulario desplegable para 
* elegir el grupo deseado para ver los partidos
*
*/
...
if (isset($errors['editable'])) {
    echo $errors['editable'];
}
?>
<form action="index.php?controller=confrontation&amp;action=select"
	method="POST">
	<div class="container">
      ...
      <?php } ?>
				...
				<div class="form-group">
					<label for="idCampeonato" size="1"> <?= i18n("Group") ?> </label> <select
				...
				<div class="form-group">
					<label for="fase" size="1"> <?= i18n("Phase") ?> </label> <select
						class="form-control" name="fase" id="fase">
