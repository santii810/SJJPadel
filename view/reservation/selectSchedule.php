...
<div class="container">
	<div class="row">
		...
		<div class="col-md-2 col sm-3 ">
			<button type="button" class="btn btn-success btn-xs" disabled>Libre</button>
		</div>
		<div class="col-md-3 col-sm-5">
			<button type="button" class="btn btn-warning btn-xs" disabled>Ultima
				pista</button>
		</div>
		<div class="col-md-2 col-sm-3">
...
<form action="index.php?controller=reservation&amp;action=add"
	method="POST">
	<div class="container">
      <?php
				...
				<div class="container">
					...
					<div class="row">
						<div class="col-xl-10">
							...
							<button type="submit" name="scheduleButton"
